...
Индекс переносимых rule-артефактов docs-контура для target `jetbrains`.
...
- Каждый rule-entry MUST храниться в отдельном файле `.aiassistant/rules/<section>/<rule-id>.md`.

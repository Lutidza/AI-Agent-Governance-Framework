...
- RULE: Человеко-читаемый текст комментариев MUST быть на русском языке (описания, remarks, пояснения, changes-блоки, тексты param/returns/throws); технические идентификаторы, имена API и синтаксис тегов MAY оставаться в оригинале.

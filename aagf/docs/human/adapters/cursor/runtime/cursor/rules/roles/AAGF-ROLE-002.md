...
<!-- Source: docs/spec/roles/README.md + docs/adapters/cursor/runtime/.cursor/rules/roles/AAGF-ROLE-002.md -->
...
- Adapter runtime source: `docs/adapters/cursor/runtime/.cursor/rules/roles/AAGF-ROLE-002.md`
- Runtime compatibility: `.cursor/rules/roles/AAGF-ROLE-002.md`
- Human projection path: `runtime/cursor/rules/roles/AAGF-ROLE-002.md`

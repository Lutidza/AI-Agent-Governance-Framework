...
<!-- Source: docs/spec/workflows/README.md + docs/adapters/cursor/runtime/.cursor/rules/workflows/AAGF-WF-002.md -->
...
- Adapter runtime source: `docs/adapters/cursor/runtime/.cursor/rules/workflows/AAGF-WF-002.md`
- Runtime compatibility: `.cursor/rules/workflows/AAGF-WF-002.md`
- Human projection path: `runtime/cursor/rules/workflows/AAGF-WF-002.md`

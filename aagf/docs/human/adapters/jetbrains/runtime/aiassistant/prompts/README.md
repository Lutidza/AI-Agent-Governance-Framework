...
<!-- Source: docs/spec/manifests/docs.manifest.yaml + docs/adapters/jetbrains/runtime/.aiassistant/prompts/README.md -->

# prompts (human projection)

Этот документ является человеко-читаемой проекцией target-runtime prompts для `jetbrains`.

## Source mapping

- Product source: `docs/spec/**`
- Adapter runtime source: `docs/adapters/jetbrains/runtime/.aiassistant/prompts/README.md`
- Runtime compatibility: `.aiassistant/prompts/**`
- Human projection path: `runtime/aiassistant/prompts/**`

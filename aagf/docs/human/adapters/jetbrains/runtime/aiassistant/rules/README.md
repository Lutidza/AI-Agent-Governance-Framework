...
Этот документ является человеко-читаемой проекцией target-runtime rules для `jetbrains`.

## Source mapping

- Product source: `docs/spec/**`
- Adapter runtime source: `docs/adapters/jetbrains/runtime/.aiassistant/rules/README.md`

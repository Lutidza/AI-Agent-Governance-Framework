...
<!-- Source: docs/spec/stacks/README.md + docs/adapters/jetbrains/runtime/.aiassistant/rules/stacks/AAGF-STACK-001-stack-pack-replaceable-module.md -->

# AAGF-STACK-001 (human projection)
...
- Adapter runtime source: `docs/adapters/jetbrains/runtime/.aiassistant/rules/stacks/AAGF-STACK-001-stack-pack-replaceable-module.md`
- Runtime compatibility: `.aiassistant/rules/stacks/AAGF-STACK-001-stack-pack-replaceable-module.md`
- Human projection path: `runtime/aiassistant/rules/stacks/AAGF-STACK-001-stack-pack-replaceable-module.md`

## Контекст

- Section: `stacks` / Stacks
- Rule ID: `AAGF-STACK-001`
- Rule title: Stack Pack как заменяемый модуль
- Intent: Стековый блок должен заменяться без изменения core-политик.

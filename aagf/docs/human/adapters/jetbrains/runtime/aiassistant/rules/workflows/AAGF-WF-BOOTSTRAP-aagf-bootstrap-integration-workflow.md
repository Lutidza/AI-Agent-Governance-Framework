...
<!-- Source: docs/spec/workflows/README.md + docs/adapters/jetbrains/runtime/.aiassistant/rules/workflows/AAGF-WF-BOOTSTRAP-aagf-bootstrap-integration-workflow.md -->

# AAGF-WF-BOOTSTRAP (human projection)
...
- Adapter runtime source: `docs/adapters/jetbrains/runtime/.aiassistant/rules/workflows/AAGF-WF-BOOTSTRAP-aagf-bootstrap-integration-workflow.md`
- Runtime compatibility: `.aiassistant/rules/workflows/AAGF-WF-BOOTSTRAP-aagf-bootstrap-integration-workflow.md`
- Human projection path: `runtime/aiassistant/rules/workflows/AAGF-WF-BOOTSTRAP-aagf-bootstrap-integration-workflow.md`

## Контекст

- Section: `workflows` / Workflows
- Rule ID: `AAGF-WF-BOOTSTRAP`
- Rule title: AAGF Bootstrap Integration Workflow
- Intent: Интеграция AAGF в новый или существующий проект должна выполняться как управляемый протокол с явными фазами, confirm-gates и lock-конфигурацией.

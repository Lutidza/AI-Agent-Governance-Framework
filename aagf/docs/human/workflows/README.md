...
Назначение: Для каждой изменяемой модульной папки README.md обязателен: существующий README обновляется, отсутствующий README создается.
...
Этапы:
1. Для каждой папки с изменяемым кодом проверить наличие README.md.
2. Если README.md существует: прочитать перед началом правок и обновить после правок.
3. Если README.md отсутствует: создать README.md в этой же папке.
4. Заполнить обязательные поля version, updated_at, changes_full, changes_short.
5. Проверить согласованность README.md с кодом и валидность ссылок.
6. Зафиксировать в handoff полные пути созданных/обновленных README.md.

Handoff:
- Перечень README.md, прочитанных до начала правок.
- Перечень созданных README.md с полными путями от корня проекта.
- Перечень обновленных README.md с полными путями от корня проекта.
- Список синхронизированных разделов (usage/contracts/setup/dependencies/examples).
